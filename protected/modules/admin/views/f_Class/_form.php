<div class="form" style="width: 410px;
   ...
   <div class="row">
    ...
    <div class="row">
        <?php echo $form->labelEx($model, 'Название класс'); ?>
    ...
    <div class="row buttons">
        <?php if (!Yii::app()->request->isAjaxRequest): ?>
            <div class="row buttons ">
                <?php echo CHtml::submitButton($model->isNewRecord ? 'Создать2' : 'Сохранить2'); ?>
            </div>
                    ...
                    $this->widget('zii.widgets.jui.CJuiButton', array(
                        ...
                        'htmlOptions' => array(
                            'ajax' => array(
                                ...
                                'success' => 'function(r){
                            if(r=="success_create"){
                               $("#create_c").html(r).dialog("close"); 
                               return false;
                            }else if(r=="success_create_close"){
                               $("#create_c").html(r).dialog("open"); 
                               return false;
                            }else if(r=="success_update"){
                               $("#update_c").html(r).dialog("close"); 
                               return false;
