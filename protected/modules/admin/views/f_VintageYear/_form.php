...
<?php $form=$this->beginWidget('CActiveForm', array(
   ...
   <div class="row">
    ...
    <div class="row">
        <?php echo $form->labelEx($model, 'Название год урожая '); ?>
                    ...
                    $this->widget('zii.widgets.jui.CJuiButton', array(
                        ...
                        'htmlOptions' => array(
                            'ajax' => array(
                                ...
                                'success' => 'function(r){
                            if(r=="success_create"){
                               $("#create_vi").html(r).dialog("close"); 
                               return false;
                            }else if(r=="success_create_close"){
                               $("#create_vi").html(r).dialog("open"); 
                               return false;
                            }else if(r=="success_update"){
                               $("#update_vi").html(r).dialog("close"); 
                               return false;
