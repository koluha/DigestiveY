...
<?php $form=$this->beginWidget('CActiveForm', array(
   ...
   <div class="row">
    ...
    <div class="row">
        <?php echo $form->labelEx($model, 'Название Сорт винограда'); ?>
                    ...
                    $this->widget('zii.widgets.jui.CJuiButton', array(
                        ...
                        'htmlOptions' => array(
                            'ajax' => array(
                                ...
                                'success' => 'function(r){
                            if(r=="success_create"){
                               $("#create_gr").html(r).dialog("close"); 
                               return false;
                            }else if(r=="success_create_close"){
                               $("#create_gr").html(r).dialog("open"); 
                               return false;
                            }else if(r=="success_update"){
                               $("#update_gr").html(r).dialog("close"); 
                               return false;
